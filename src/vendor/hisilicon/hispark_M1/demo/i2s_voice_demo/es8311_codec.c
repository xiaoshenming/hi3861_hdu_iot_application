...
static unsigned int  codec_set_gain(hi_void)
{
    ...
    ret |= codec_write_reg(ES8311_DAC_REG37, 0x08);
    ret |= codec_write_reg(ES8311_ADC_REG17, 0xBF);
...
unsigned int  hi_codec_init_test(const hi_codec_attribute *codec_attr)
{
    ...
    ret |= codec_write_reg(ES8311_SYSTEM_REG14, 0x15);
    /* set dac */
    ...
    ret |= codec_write_reg(ES8311_SYSTEM_REG13, 0x00);
