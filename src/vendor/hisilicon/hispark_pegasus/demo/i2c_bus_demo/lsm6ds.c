...
void LSM6DS_Init()
{
    //LSM6DS_Write(LSM6DSL_CTRL3_C, 0x30, 2);
    ...
    //LSM6DS_Write(LSM6DSL_CTRL1_XL, 0x43, 2); // 加速度配置量程为2g,104Hz, lpf1_bw_sel=1, bw0_xl=1;
    ...
    // LSM6DS_Write(LSM6DSL_MD1_CFG, 0x20, 2);
