...
static void NFCTagTodayHeadlineMode(void)
{
    ...
    if (ret != 0) {
        printf("get ndefFile TodayHeadline Failed\r\n");
    }
}
...
static void NFCTagTaobaoMode(void)
{
    ...
    if (ret != 0) {
        printf("get ndefFile Taobao Failed\r\n");
    }
}
...
static void NFCTagHWSmartLifeMode(void)
{
    ...
    if (ret != 0) {
        printf("get ndefFile HWSmartLife data Failed\r\n");
    }
}
...
static void NFCTagHistreamingMode(void)
{
    ...
    if (ret != 0) {
        printf("get ndefFile Histreaming data Failed\r\n");
    }
}
    ...
    while (1) {
        switch (GetKeyStatus(CURRENT_MODE)) {
            ...
            case NFC_TAG_TODAY_HEADLINE_MODE:
                NFCTagTodayHeadlineMode();
                break;
            case NFC_TAG_TAOBAO_MODE:
                NFCTagTaobaoMode();
                break;
            case NFC_TAG_HW_LIFE_MODE:
                NFCTagHWSmartLifeMode();
                break;
            case NFC_TAG_HISTREAMING_MODE:
                NFCTagHistreamingMode();
                break;
