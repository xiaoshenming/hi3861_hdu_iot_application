                       ...
                       unsigned char sendLen, unsigned char readLen)
{
    ...
    IoTI2cWrite(IOT_I2C_IDX_0, C081_NFC_ADDR & 0xFE, c081NfcI2cWriteCmdAddr.sendBuf, c081NfcI2cWriteCmdAddr.sendLen);

    IoTI2cRead(IOT_I2C_IDX_0, C081_NFC_ADDR | I2C_RD, co8iNfcI2cReadData.receiveBuf, co8iNfcI2cReadData.receiveLen);
    return 0;
}
