...
* 步骤1：../code/hi3861_hdu_iot_application/src/vendor/hisilicon/hispark_pegasus/demo/cw2015_demo文件夹复制到../code/hi3861_hdu_iot_application/src/applications/sample/wifi-iot/app/目录下。
...
* 步骤1：../code/hi3861_hdu_iot_application/src/vendor/hisilicon/hispark_pegasus/demo/nfc_demo文件夹复制到../code/hi3861_hdu_iot_application/src/applications/sample/wifi-iot/app/目录下。
...
* 步骤1：../code/hi3861_hdu_iot_application/src/vendor/hisilicon/hispark_pegasus/demo/i2c_bus_demo文件夹复制到../code/hi3861_hdu_iot_application/src/applications/sample/wifi-iot/app/目录下。
...
* 步骤1：../code/hi3861_hdu_iot_application/src/vendor/hisilicon/hispark_pegasus/demo/lth1550_demo文件夹复制到../code/hi3861_hdu_iot_application/src/applications/sample/wifi-iot/app/目录下。
...
* 步骤1：../code/hi3861_hdu_iot_application/src/vendor/hisilicon/hispark_pegasus/demo/uart_demo文件夹复制到../code/hi3861_hdu_iot_application/src/applications/sample/wifi-iot/app/目录下。
...
- 步骤4：修改.device/hisilicon/hispark_pegasus/sdk_liteos/build/config/usr_config.mk文件。在这个配置文件中打开UART驱动宏。搜索字段CONFIG_UART1_SUPPORT ，并打开UART1。配置如下：
...
* 步骤1：../code/hi3861_hdu_iot_application/src/vendor/hisilicon/hispark_pegasus/demo/wifi_demo文件夹复制到../code/hi3861_hdu_iot_application/src/applications/sample/wifi-iot/app/目录下。
...
* 步骤1：../code/hi3861_hdu_iot_application/src/vendor/hisilicon/hispark_pegasus/demo/thread_demo文件夹复制到../code/hi3861_hdu_iot_application/src/applications/sample/wifi-iot/app/目录下。
...
* 步骤1：../code/hi3861_hdu_iot_application/src/vendor/hisilicon/hispark_pegasus/demo/semaphore_demo文件夹复制到../code/hi3861_hdu_iot_application/src/applications/sample/wifi-iot/app/目录下。
...
* 步骤1：../code/hi3861_hdu_iot_application/src/vendor/hisilicon/hispark_pegasus/demo/timer_demo文件夹复制到../code/hi3861_hdu_iot_application/src/applications/sample/wifi-iot/app/目录下。
...
* 步骤1：../code/hi3861_hdu_iot_application/src/vendor/hisilicon/hispark_pegasus/demo/interrupt_demo文件夹复制到../code/hi3861_hdu_iot_application/src/applications/sample/wifi-iot/app/目录下。
...
* 如果使用扩展IO口左右红外管测距
    ...
    完整代码参考：trace_ex_demo。本demo 实现了S1按键菜单选项栏，进入对应界面修改小车前进速度，左转右转速度，通过S2,S3增加每个模块对应参数值。在主界面时，通过S2,S3按键实现小车开启停止寻迹。小车左轮在黑线时，小车左大灯亮白光，右轮转动，小车右轮在黑线时，小车右大灯亮白灯，小车左轮转动，小车两边都不在黑线时，小车前进。具体请参考工程代码。（烧录固件后, 根据不同的小车的个体差异, 可能需要微调参数，同时根据自己需要调节滑动变阻器RP2和RP3）。
