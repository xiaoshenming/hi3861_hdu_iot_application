...
55     ssd1306_printf("TL:%d, TR:%d", car_drive.TurnRight, car_drive.TurnLeft);
56 }
57 
...
78             ssd1306_printf("TL:%d, TR:%d", car_drive.TurnRight, car_drive.TurnLeft);
79             break;
...
116             car_drive.TurnRight += ((button_pressed) ? -1 : 1);
117             ssd1306_printf("TurnLeft=%d", car_drive.TurnRight);
118             break;
119         case MODE_SET_TURN_RIGHT:
120             car_drive.TurnLeft += ((button_pressed) ? -1 : 1);
