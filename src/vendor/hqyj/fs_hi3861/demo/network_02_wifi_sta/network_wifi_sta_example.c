...
#define WIFI_SSID "AI_DEV"
#define WIFI_PAWD "HQYJ12345678"
...
static void network_wifi_sta_example(void)
{
    printf("Enter network_wifi_sta_example()!\r\n");
...
SYS_RUN(network_wifi_sta_example);