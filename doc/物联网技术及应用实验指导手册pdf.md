...
<font color='RedOrange'>**说明：Hi3861V100编译目前提供一种编译方式，第1.1.4节“导入工程”，编译成功后，可以学习第1.1.5节“代码烧录”完成开发板烧录。**</font>
...
* 步骤二：在导入工程弹窗中选择Hi3861 SDK目录，点击“导入”。导入路径选择与src、build目录层级（**如果采用zip包下载，SDK名称为hi3861_hdu_iot_application-master，如果采用git下载SDK名称为hi3861_hdu_iot_application，此处以采用zip下载为例，注意如果出现无法导入的问题，请检查目录层级是否正确，防止目录层级嵌套**）

  ![image-20230103100700706](pic/20240417154845.png)
...
- 步骤三：编译成功后，**开发板烧录可以参考第1.1.4节“代码烧录”**。
...
* 步骤三：通过命令行进入到../hi3861_hdu_iot_application-master/src目录下（如果采用zip包下载，SDK名称为hi3861_hdu_iot_application-master，如果采用git下载SDK名称为hi3861_hdu_iot_application，此处以采用zip下载为例，命令行进入目录操作请自行百度；<font color='RedOrange'>**注意：请不要关闭该命令行窗口，后续步骤都在此窗口下进行**</font>）

![image-20230103104350440](pic/image-20230103104350440.png)

* 步骤四：进入src目录下后，输入指令“hb set”，敲一次“Enter”，然后通过键盘方向键选择“wifiiot_hispark_pegasus”，input code path选择“wifiiot_hispark_pegasus”，选择完成后再敲一次“Enter”。
